...
[6, 4, _, 4, 4, _, 3, _, _, _, _, _, _, _, _, _, 4, _, _, _, 6, _, _, _, _, _, _, _, _, _, _, _, 2, _, _, 2, _, 2, _, _, 2, 2, 2, 5, _, 1, _, 5],
[6, _, _, _, _, _, 4, _, 6, 6, 6, _, _, 6, _, _, 4, _, _, _, 6, _, _, _, _, _, _, _, 2, _, 2, _, _, _, _, _, _, _, _, _, _, 2, 2, 5, _, _, _, 5],
